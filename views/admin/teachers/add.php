...
<head>
    ...
    <title data-fr="Ajouter Enseignant - Système de Gestion" data-en="Add Teacher - Management System">Ajouter Enseignant - Système de Gestion</title>
    ...
    <style>
        * {
        ...
        /* Style spécifique pour les sélecteurs de module */
    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="page-title">
                ...
                <h2 class="translatable" data-fr="Ajouter un nouvel enseignant" data-en="Add a new teacher">Ajouter un nouvel enseignant</h2>
            </div>
            ...
            <div class="form-container">
                <div class="form-header">
                    <i class="fas fa-chalkboard-teacher"></i>
                    <h3 class="translatable" data-fr="Informations de l'enseignant" data-en="Teacher Information">Informations de l'enseignant</h3>
                </div>
                ...
                <form method="post" id="teacherForm">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" 
                                   placeholder="<?php echo htmlspecialchars(isset($_SESSION['lang']) && $_SESSION['lang'] === 'en' ? 'Ex: Sarah Johnson' : 'Ex: Marie Martin'); ?>" 
                                   required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" 
                                   placeholder="<?php echo htmlspecialchars(isset($_SESSION['lang']) && $_SESSION['lang'] === 'en' ? 'Ex: sarah.johnson@school.edu' : 'Ex: marie.martin@ecole.fr'); ?>" 
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="classSelect">
                                ...
                                <span class="translatable" data-fr="Classe assignée :" data-en="Assigned Class:">Classe assignée :</span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="moduleSelect">
                                ...
                                <span class="translatable" data-fr="Module enseigné :" data-en="Teaching Module:">Module enseigné :</span>
                            </label>
                            <div class="select-wrapper">
                                <select id="moduleSelect" name="module" required disabled>
                                    <option value="" class="translatable" data-fr="-- Sélectionnez d'abord une classe --" data-en="-- First select a class --">-- Sélectionnez d'abord une classe --</option>
                                </select>
                                <i class="fas fa-chevron-down"></i>
                            </div>
                        </div>
                    ...
                    <div class="form-note">
                        ...
                        <span class="translatable" data-fr="L'enseignant pourra se connecter avec son email et le mot de passe défini ci-dessus." 
                              data-en="The teacher will be able to log in with their email and the password defined above.">
                            L'enseignant pourra se connecter avec son email et le mot de passe défini ci-dessus.
                        </span>
                    </div>
                    ...
                    <div class="form-buttons">
                        ...
                        <button type="submit" class="btn btn-primary">
                            ...
                            <span class="translatable" data-fr="Ajouter l'enseignant" data-en="Add Teacher">Ajouter l'enseignant</span>
                        </button>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        const classModules = {
            <?php foreach ($classes as $class): ?>
                "<?= $class['id'] ?>": [
                    <?php 
                    // Vérifier si l'élément modules existe et a des enfants
                    if (isset($class->modules) && isset($class->modules->module)): 
                        $first = true;
                        foreach ($class->modules->module as $module): 
                            if (!$first) echo ',';
                            echo '"' . addslashes(htmlspecialchars($module)) . '"';
                            $first = false;
                        endforeach; 
                    endif; 
                    ?>
        ...
        function updatePlaceholders(lang) {
            const placeholders = {
                ...
                'email': {
                    'fr': 'Ex: marie.martin@ecole.fr',
                    'en': 'Ex: sarah.johnson@school.edu'
                },
                'password': {
        ...
        document.getElementById("classSelect").addEventListener("change", function () {
            ...
            if (selectedValue) {
                moduleSelect.innerHTML = '<option value="" class="translatable" data-fr="-- Sélectionnez un module --" data-en="-- Select a module --">-- Sélectionnez un module --</option>';
                moduleSelect.disabled = false;
                
                const modules = classModules[selectedValue] || [];
                if (modules.length > 0) {
                    modules.forEach(m => {
                    ...
                    moduleSelect.innerHTML = '<option value="" class="translatable" data-fr="Aucun module disponible" data-en="No module available">Aucun module disponible</option>';
                    moduleSelect.disabled = true;
                }
                
                // Appliquer la traduction aux nouvelles options
                document.querySelectorAll('#moduleSelect .translatable').forEach(element => {
                    const text = element.getAttribute(`data-${lang}`);
                    if (text) {
                        element.textContent = text;
                    }
                ...
                moduleSelect.innerHTML = '<option value="" class="translatable" data-fr="-- Sélectionnez d\'abord une classe --" data-en="-- First select a class --">-- Sélectionnez d\'abord une classe --</option>';
                moduleSelect.disabled = true;
                
                // Appliquer la traduction
                const option = moduleSelect.querySelector('option');
                if (option && option.getAttribute(`data-${lang}`)) {
                    option.textContent = option.getAttribute(`data-${lang}`);
                }
            }
            
            // Animation
            moduleSelect.style.animation = 'none';
            setTimeout(() => {
                moduleSelect.style.animation = 'fadeIn 0.3s ease-out';
            }, 10);
        });
        ...
        document.getElementById("teacherForm").addEventListener("submit", function(e) {
            ...
            if (!selectedModule || document.getElementById("moduleSelect").disabled) {
                e.preventDefault();
                const message = lang === 'en' 
            ...
            const confirmationMessage = lang === 'en' 
                ...
                : "Êtes-vous sûr de vouloir ajouter cet enseignant ?";
